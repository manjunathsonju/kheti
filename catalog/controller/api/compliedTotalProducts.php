<?php
Class ControllerApiCompiledTotalProducts extends Controller{
...
//            var_dump($queryresult);
            $queryresult = $this->db->query("SELECT * from oc_order_product op  JOIN "."oc_order o ON (o.order_id=op.order_id) WHERE o.order_status_id !="."7"." AND o.order_status_id !="."0"." AND o.order_status_id !="."8"." AND op.order_id BETWEEN ".$_GET['from']." AND ".$_GET['to']." AND op.product_id=".$productid['product_id']);
