...
class ControllerApiKhetifoodhome extends Controller
{
    public function index()
    {
        if ($this->request->post['key'] == '!3t3kf0odh0m3') {
            ...
            if (
                ...
                $this->request->post['location'] != null
            ) {
            ...
            $json['components'] = [
                ...
                '8' => [
                    ...
                    'content' => $this->model_kheti_products->getcategories(
                        $location,
                        1
                    ),
                ],
                ...
                '9' => [
                    ...
                    'content' => $this->model_kheti_components->index(
                        $location,
                        1
                    ),
                ],
                ...
                '10' => [
                    ...
                    'content' => [
                        $this->model_kheti_products->categoryjson(
                            172,
                            $location
                        ),
                        $this->model_kheti_products->categoryjson(
                ...
                '13' => [
                    ...
                    'content' => $this->model_kheti_products->getprodcuts(
                        217,
                        $location
                    ),
                ],
                ...
                '14' => [
                    ...
                    'content' => $this->model_kheti_components->vendors(
                        $location
                    ),
                ],
                ...
                '15' => [
                    ...
                    'content' => $this->model_kheti_products->getbestselling(
                        $location,
                        1
                    ),
                ],
            ...
            $sql =
                "SELECT * FROM `app_B2C_home` WHERE location='" .
                $location .
                "'";
            $tokn = $this->db->query($sql);
            foreach ($tokn->rows as $result) {
                if ($result['status'] == '0') {
                    $json['components'][$result['component_id']] = [
                        'component_id' => 7,
                    ...
                    $json['components'][$result['component_id']] = [
                        ...
                        'href' => $result['href'],
                        'type' => $result['type'],
                        'filter' => $result['filter'] == '0' ? false : true,
                    ];
                }
            }
    ...
    public function forgetpassword()
    {
        ...
        $data['reset'] =
            'https://khetifood.com/index.php?route=account/reset&code=' . $code;
    ...
    {
        $sql =
            "SELECT session_id FROM `oc_cart` WHERE cart_id=(SELECT MAX(cart_id) FROM oc_cart WHERE customer_id='" .
            $customer_id .
            "')";
    ...
    {
        $sql =
            "SELECT MAX(order_id) AS order_id FROM `oc_order` WHERE customer_id='" .
            $customer_id .
    ...
    public function logout()
    {
        ...
        if ($login) {
            $sql =
                "UPDATE `oc_customer` SET token_app='' WHERE customer_id='" .
                $this->request->post['customer_id'] .
                "'";
            $this->db->query($sql);
        ...
        if ($customer_info->row['email']) {
            if (
                ...
                if ($customer_info->row['token_app'] != null) {
                    ...
                    $json['token'] = $token;
                    $sql =
                        "UPDATE `oc_customer` SET token_app='" .
                        $token .
                        "' WHERE customer_id='" .
                ...
                $sql =
                    "INSERT INTO `customer_login_app` (customer_id,ip,device_info,date_added,status) VALUES ('" .
                    $customer_info->row['customer_id'] .
                    "','" .
                    $this->request->post['ip'] .
                    "','" .
                    $this->db->escape($this->request->post['device_info']) .
                    "',NOW(),'1')";
                $this->db->query($sql);
                ...
                if (
                    $this->request->post['location'] &&
                    $customer_info->row['location'] == null
                ) {
                    $sql =
                        "UPDATE `oc_customer` SET location='" .
                        $this->request->post['location'] .
                        "' WHERE customer_id='" .
                        $customer_info->row['customer_id'] .
                        "'";
                ...
                if (
                    ...
                    $this->request->post['session_id'] != null
                ) {
                    $sessioninformation = $this->findsession(
                        $customer_info->row['customer_id']
                    );
                    if ($sessioninformation) {
                        $sql =
                            "SELECT * FROM `oc_cart` WHERE session_id='" .
                            $this->request->post['session_id'] .
                            "'";
                        ...
                        foreach ($products->rows as $result) {
                            ...
                            if ($products_exist->row['product_id']) {
                                $sql =
                                    'UPDATE `oc_cart` SET quantity=quantity+' .
                                    (int) $result['quantity'] .
                                    " WHERE session_id='" .
                                    $sessioninformation .
                                    "' AND product_id='" .
                        ...
                        $sql =
                            "UPDATE `oc_cart` SET customer_id='" .
                            $customer_info->row['customer_id'] .
                            "' WHERE session_id='" .
                            $this->request->post['session_id'] .
                            "'";
    ...
    public function register()
    {
        if ($this->request->post['key'] == '!3t3kf00dr3g1ater') {
            if (
                ...
                $customer_id_email = $this->model_account_customer->getCustomerByEmail(
                    $this->request->post['email']
                );
                $customer_id_num = $this->model_account_customer->getCustomerByPhone(
                    $this->request->post['number']
                );
                // register
                if ($customer_id_email == null && $customer_id_num == null) {
                    $this->db->query(
                        'INSERT INTO ' .
                            DB_PREFIX .
                            "customer SET customer_group_id = '" .
                            '1' .
                            "', store_id = '" .
                            '1' .
                            "', language_id = '" .
    ...
    public function addtocart()
    {
        if ($this->request->post['key'] == '@d!3t3kf0dc@rt') {
            ...
            if (
                $this->request->post['option_id'] &&
                $this->request->post['option_id'] != null
            ) {
            ...
            if (
                $this->request->post['customer_id'] &&
                $this->request->post['customer_id'] != null
            ) {
                $sessioninformation = $this->findsession(
                    $this->request->post['customer_id']
                );
            ...
            if (
                $this->request->post['session_id'] &&
                $session_status->row['session_id'] &&
                $this->request->post['session_id'] != null
            ) {
                if (
                    $prodcut_exist->row['product_id'] ==
                    $this->request->post['product_id']
                ) {
                    //if already in cart
                    $this->model_kheti_products->updatecart(
                    ...
                    $cart_id = $this->model_kheti_products->addtocart(
                        $customer_id,
                        $session_status->row['session_id'],
                        $this->request->post['product_id'],
                        $optx,
    ...
    public function checkcartproducts()
    {
        if ($this->request->post['session_id']) {
            if ($this->request->post['option_id']) {
                $sql =
                    "SELECT cart_id,quantity,product_id FROM `oc_cart` WHERE session_id='" .
                    $this->request->post['session_id'] .
                    "' AND product_id='" .
                    $this->request->post['product_id'] .
                    "' AND `option`='" .
            ...
            if ($this->request->post['option_id']) {
                $sql =
                    "SELECT op.order_product_id AS cart_id,op.quantity,op.product_id FROM `oc_order_product` op JOIN oc_order_option opp ON (op.order_product_id=opp.order_product_id) WHERE op.order_id='" .
                ...
                $sql =
                    "SELECT order_product_id AS cart_id,quantity,product_id FROM `oc_order_product` WHERE order_id='" .
                    $this->request->post['order_id'] .
                    "' AND product_id='" .
                    $this->request->post['product_id'] .
                    "'";
    ...
    public function getcartproducts()
    {
        if ($this->request->post['key'] == 'g3t!3t3kf0dc@rt') {
            ...
            if ($session && $session != null) {
                $sql =
                    "SELECT c.* FROM `oc_cart` c JOIN oc_product p ON (p.product_id=c.product_id) JOIN oc_product_to_store ps ON (ps.product_id=p.product_id) WHERE p.status=1 AND c.session_id='" .
                    $session .
                    "' AND ps.store_id=1";
                $products = $this->db->query($sql);
                $subtotal = 0;
                ...
                foreach ($products->rows as $result) {
                    if (
                        ...
                        $sql =
                            "SELECT * FROM `product_options` WHERE options='" .
                            $result['option'] .
                            "'";
                        $optionx = $this->db->query($sql);
                        $sql =
                            "UPDATE `oc_cart` SET option_id='" .
                            $optionx->row['option_id'] .
                            "' WHERE cart_id='" .
                            $result['cart_id'] .
                            "'";
                        $this->db->query($sql);
                    ...
                    $image =
                        'https://khetifood.com/image/' . $product_info['image'];
                    ...
                    $sql =
                        "SELECT * FROM `oc_maximum` WHERE product_id='" .
                        $result['product_id'] .
                        "'";
                    $maximum = $this->db->query($sql);
                    if (
                        $maximum->row['maximum'] != '0' &&
                        (int) $maximum->row['maximum'] <
                            (int) $result['quantity']
                    ) {
                        $stock_status = 'Out Of Stock';
                    }
                ...
                ] = $this->model_kheti_products->getprodcuts(217, $location);
                $json['banner'] = [
                    'component_name' => 'Dashain Dhamaka',
                    'image' => 'https://khetifood.com/image/test/pay.jpg',
                    'href' => '',
                    'type' => '',
                ];
                // $json['banner']= null;
    ...
    public function editcartproducts()
    {
        if ($this->request->post['key'] == '3!t!3t3kf0dc@rt') {
            ...
            if (
                ...
                $prodcut_exist = $this->db->query($sql);
                if (
                    $prodcut_exist->row['option'] != 0 ||
                    $prodcut_exist->row['option'] != '[]'
                ) {
                    $sql =
                        "SELECT * FROM `product_options` WHERE option_id='" .
                        $prodcut_exist->row['option_id'] .
                        "'";
                    $option_name = $this->db->query($sql);
                    $price = $option_name->row['price'];
                } else {
                ...
                $json['price'] = $price;
                $json['product_total'] =
                    $price * (float) $this->request->post['quantity'];
    ...
    public function removecartproduct()
    {
        if ($this->request->post['key'] == 'd3l3t3kf0dc@rt') {
            ...
            if (
                ...
                $sql =
                    "DELETE FROM `oc_cart` WHERE session_id='" .
                    $this->request->post['session_id'] .
                    "' AND cart_id='" .
                    $this->request->post['cart_id'] .
                    "'";
    ...
    public function search()
    {
        if ($this->request->post['key'] == 'S3@rchm3') {
            ...
            foreach ($categories_1 as $category_1) {
                ...
                $categories_2 = $this->model_catalog_category->getCategories(
                ...
                foreach ($categories_2 as $category_2) {
                    ...
                    $categories_3 = $this->model_catalog_category->getCategories(
            ...
            if (
                ...
                foreach ($results as $result) {
                    ...
                    //$category_name = '';
                    $category = $this->model_catalog_product->getCategories(
                        $result['product_id']
                    );
                    if ($category) {
                        $category_array = $this->model_catalog_category->getCategory(
                    ...
                    //for options
                    $sql =
                        "SELECT * FROM product_to_option op JOIN product_options p ON (op.option_group_id=p.option_group_id) WHERE op.product_id='" .
                        $result['product_id'] .
                        "' ORDER BY p.option_id";
                    ...
                    $data['products'][] = [
                        ...
                        'tax' => $tax,
                        'minimum' =>
                            $result['minimum'] > 0 ? $result['minimum'] : 1,
                ...
                if (
                    isset($this->request->post['search']) &&
                    $this->config->get('config_customer_search')
                ) {
    ...
    public function getAddresses()
    {
        if ($this->request->post['key'] == 'G3t@dres') {
            $this->load->model('kheti/components');
            $json['address'] = $this->model_kheti_components->address(
                $customer_id
            );
        }
        $this->response->addHeader('Content-Type: application/json');
    ...
    public function deleteAddress()
    {
        if ($this->request->post['key'] == 'D3l@dres') {
            $sql =
                "DELETE FROM `oc_address` WHERE address_id='" .
    ...
    public function editAddress()
    {
        if ($this->request->post['key'] == '@dres') {
            $sql =
                "UPDATE `oc_address` SET firstname='" .
                $this->request->post['firstname'] .
                "',lastname='" .
                $this->request->post['lastname'] .
                "',company='" .
    ...
    public function insertAddress()
    {
        if ($this->request->post['key'] == '!ns3rt@dres') {
            ...
            $sql =
                "INSERT INTO `oc_address` (customer_id,firstname,lastname,company,address_1,address_2,city,postcode,country_id,zone_id,custom_field) VALUES ('" .
                $this->request->post['customer_id'] .
                "','" .
                $this->request->post['firstname'] .
                "','" .
        ...
        if ($login) {
            ...
            if (
                ...
                foreach ($products->rows as $result) {
                    ...
                    $total =
                        (float) $priceofproduct * (float) $result['quantity'];
                    $subtotal = $subtotal + $total;

                    $this->db->query(
                        "INSERT INTO oc_order_product SET order_id = '" .
                            $order_id .
                            "', product_id = '" .
                            $result['product_id'] .
                            "', name = '" .
                            ...
                            "', model = '" .
                            $this->db->escape($product_info['model']) .
                            "', quantity = '" .
                            $result['quantity'] .
                            "', price = '" .
                            $priceofproduct .
                    ...
                    if (
                        ...
                        $sql =
                            "INSERT INTO `oc_order_option` (`order_id`,`order_product_id`,`product_option_id`,`product_option_value_id`,`name`,`value`,`type`) VALUES ('" .
                            $order_id .
                            "','" .
                            $order_product_no .
                            "',0,0,'Weight/quantity','" .
                ...
                if ($this->request->post['code']) {
                    $result_coupon = $this->model_extension_total_coupon->getCoupon1(
                    ...
                    if ($result_coupon) {
                        ...
                        $sql =
                            "INSERT INTO `oc_order_total` (order_id,code,title,value,sort_order) VALUES ('" .
                            $order_id .
                            "','coupon','Coupon (" .
                            $this->request->post['code'] .
                            ")','" .
    ...
    public function confirm()
    {
        ...
        if ($orderispro->row['order_id']) {
            if (
                $this->request->post['billing_address_id'] &&
                ...
                $customer_info = $this->db->query($sql);
                if (
                    $customer_info->row['token_app'] ==
                    $this->request->post['token']
                ) {
                    $sql =
                        "SELECT * FROM `oc_address` WHERE address_id='" .
                        $this->request->post['billing_address_id'] .
                        "'";
                    ...
                    if (
                        ...
                        $this->request->post['payment_method'] == 'Esewa'
                    ) {
                        $payment_code = 'cod2';
                    } elseif (
                        $this->request->post['payment_method'] ==
                        ...
                        $this->request->post['payment_method'] == 'Fonepay'
                    ) {
                        $payment_code = 'cod1';
                    } elseif (
                        $this->request->post['payment_method'] == 'CellPay'
                    ) {
                    ...
                    $sql =
                        "UPDATE `oc_order` SET payment_firstname='" .
                        $customerpay->row['firstname'] .
                        "',payment_lastname='" .
                        $customerpay->row['lastname'] .
                        "',payment_company='" .
                        $customerpay->row['company'] .
                        "',payment_address_1='" .
                        $customerpay->row['address_1'] .
                        "',payment_address_2='" .
                        $customerpay->row['address_2'] .
                        "',payment_city='" .
                        $customerpay->row['city'] .
                        "',payment_postcode='" .
                        $customerpay->row['postcode'] .
                        "',payment_country='" .
                        $customerpay->row['country_id'] .
                        "',payment_country_id='" .
                        (int) $customerpay->row['country_id'] .
                        "',payment_zone='" .
                        $customerpay->row['zone_id'] .
                        "',payment_zone_id='" .
                        (int) $customerpay->row['zone_id'] .
                        "',payment_custom_field='" .
                        $customerpay->row['custom_field'] .
                        "',payment_method='" .
                        $this->request->post['payment_method'] .
                        "',payment_code='" .
                        $payment_code .
                        "',shipping_firstname='" .
                        $customership->row['firstname'] .
                        "',shipping_lastname='" .
                        $customership->row['lastname'] .
                        "',shipping_company='" .
                        $customership->row['company'] .
                        "',shipping_address_1='" .
                        $customership->row['address_1'] .
                        "',shipping_address_2='" .
                        $customership->row['address_2'] .
                        "',shipping_city='" .
                        $customership->row['city'] .
                        "',shipping_postcode='" .
                        (int) $customership->row['postcode'] .
                        "',shipping_country='" .
                        $customership->row['country_id'] .
                        "',shipping_country_id='" .
                        (int) $customership->row['country_id'] .
                        "',shipping_custom_field='" .
                        $customership->row['custom_field'] .
                        "',shipping_method='" .
                        $this->request->post['shipping_method'] .
                        "',shipping_code='" .
                        $ship_code .
                        "',comment='" .
                        $comment .
                        "',order_status_id=1, date_added = NOW(),date_modified = NOW() WHERE order_id='" .
                        $this->request->post['order_id'] .
                        "'";
                    $this->db->query($sql);
                    ...
                    if ($this->request->post['date_delivery']) {
                        $sql =
                            "INSERT INTO `order_delivery` (order_id,date_added,date_delivery) VALUES ('" .
                            $this->request->post['order_id'] .
                            "',NOW(),'" .
                            $this->request->post['date_delivery'] .
                            "')";
                        $this->db->query($sql);
                    }
                    ...
                    $messageString =
                        ...
                        "\n" .
                        'First name: ' .
                        $orderispro->row['firstname'] .
                        "\n" .
                        'Last Name: ' .
                        $orderispro->row['lastname'] .
                        "\n" .
                        'Total: ' .
                        strval((float) $orderispro->row['total']);
    ...
    public function getinformation()
    {
        ...
        if ($information_info) {
            ...
            $json['description'] = html_entity_decode(
                $information_info['description'],
                ENT_QUOTES,
                'UTF-8'
            );
    ...
    public function getorderinfo()
    {
        ...
        $order_info = $this->model_account_order->getOrderinfos(
            $order_id,
            $customer_id
        );
        ...
        if ($order_info) {
            ...
            if ($order_info['invoice_no']) {
                $data['invoice_no'] =
                    $order_info['invoice_prefix'] . $order_info['invoice_no'];
            } else {
                $data['invoice_no'] = '';
            }
            ...
            foreach ($products as $product) {
                ...
                foreach ($options as $option) {
                    ...
                    $option_data[] = [
                        'name' => $option['name'],
                        'value' =>
                            utf8_strlen($value) > 20
                                ? utf8_substr($value, 0, 20) . '..'
                                : $value,
                    ];
                }
            ...
            // Voucher
            $data['vouchers'] = [];
            $vouchers = $this->model_account_order->getOrderVouchers(
                $this->request->get['order_id']
            );
            ...
            $totals = $this->model_account_order->getOrderTotals(
                $this->request->get['order_id']
            );
            ...
            $results = $this->model_account_order->getOrderHistories(
                $this->request->get['order_id']
            );
...
<div class="content-item">
			...
			<table class="table  table-striped  table-bordered border-primary " style="width: 375px; margin: 10px 10px;">
				...
				<tbody>                                 
							...
							<tr>
									...
									<td><i class="fa fa-calendar" aria-hidden="true" style="padding: 5px;"></i>' .
            $data['date_added'] .
            '</td>
				...
				<thead class="table-light ">
						...
						<tbody>                                  
							<tr>
									...
									<td> <i class="fa fa-user-circle" aria-hidden="true" style="padding:5px;"></i>' .
            $customer_info->row['firstname'] .
            ' ' .
            $customer_info->row['lastname'] .
            '</td>
							...
							<tr>
									...
									<td><i class="fa fa-envelope" aria-hidden="true" style="padding: 5px;"></i>' .
            $customer_info->row['email'] .
            '</td>
							...
							<tr>
								...
								<td><i class="fa fa-mobile" aria-hidden="true" style="padding: 5px;"></i>' .
            $customer_info->row['telephone'] .
            '</td>
    ...
    public function profile()
    {
        if (
            ...
            if (
                ...
                $json['location'] = $customer_info->row['location'];
                $query = $this->db->query(
                    'SELECT o.order_id, o.firstname, o.lastname, os.name as status, o.date_added, o.total, o.currency_code, o.currency_value FROM `' .
                        DB_PREFIX .
                        'order` o LEFT JOIN ' .
                        DB_PREFIX .
                        "order_status os ON (o.order_status_id = os.order_status_id) WHERE o.customer_id = '" .
                        $this->request->post['customer_id'] .
                        "' AND o.order_status_id > '0' AND o.store_id = '1' AND os.language_id = '1' ORDER BY o.order_id DESC"
                );
    ...
    public function getrewards()
    {
        ...
        if ($this->request->post['customer_id']) {
            ...
            if ($results) {
                $resultstotal = $this->model_account_reward->getTotalPoints1(
                    $customer_id
                );
    ...
    public function getwishlist()
    {
        ...
        $this->load->model('tool/image');
        $results = $this->model_account_wishlist->getWishlist1(
            $this->request->post['customer_id']
        );
        if ($results) {
            foreach ($results as $result) {
                ...
                if ($product_info) {
                    ...
                    $this->model_account_wishlist->deleteWishlist1(
                        $this->request->post['customer_id'],
                        $result['product_id']
                    );
                }
    ...
    {
        $this->load->model('account/wishlist');
        $results = $this->model_account_wishlist->addWishlist1(
            $this->request->post['customer_id'],
            $this->request->post['product_id']
        );
    ...
    {
        $this->load->model('account/wishlist');
        $results = $this->model_account_wishlist->deleteWishlist1(
            $this->request->post['customer_id'],
            $this->request->post['product_id']
        );
    ...
    {
        $this->load->model('extension/total/coupon');
        $results = $this->model_extension_total_coupon->getCoupon1(
            $this->request->post['code'],
            $this->request->post['customer_id']
        );
