...
class ControllerExtensionAccountPurpletreeMultivendorSellers extends Controller {
	public function index() {
		...
		$farmer_market = '';
		if (isset($this->request->get['farmer_market'])) {
			$farmer_market = $this->request->get['farmer_market'];
		}
		...
		if($seller_totals ==0) {
			...
			$pagination->url = $this->url->link('extension/account/purpletree_multivendor/sellers',$url . '&page={page}&farmer_market='.$farmer_market,true);
