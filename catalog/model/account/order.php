...
class ModelAccountOrder extends Model {
	...
	public function getOrderinfos($order_id,$customer_id) {
		$order_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "order` WHERE order_id = '" . (int)$order_id . "' AND customer_id = '" . $customer_id . "' AND order_status_id > '0'");
