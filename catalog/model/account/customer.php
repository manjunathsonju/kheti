...
class ModelAccountCustomer extends Model {
	...
	public function getTotalCustomersByMobile($telephone) {
    ...
    public function getCustomerGroup($customer_id){
        $query = $this->db->query("SELECT * FROM oc_customer c JOIN oc_customer_group_description cgd ON (c.customer_group_id=cgd.customer_group_id) WHERE customer_id=" . (int)$customer_id);
