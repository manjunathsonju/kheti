<?php
class ControllerReportsReportB2B extends Controller {
	public function index() {
		...
		$sales_total = $this->model_reports_report->getsalesreportB2B($this->request->get['Product_id_filter'],$date_from,$date_to);
        ...
        $data['href'] = 'index.php?route=reports/reportB2B&user_token='.$this->request->get['user_token'];
