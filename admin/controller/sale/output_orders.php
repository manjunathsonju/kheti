<?php
class ControllerSaleOutputOrders extends Controller {
	private $error = array();
	...
	protected function getList() {
		...
		$order_total = $this->model_sale_order->getTotalOrdersByStoreId($filter_data['store_id']);
		...
		$pagination->url = $this->url->link('sale/output_orders', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('sale/order_list_output', $data));
	}
