<?php
class ControllerSaleInputOrders extends Controller {
	private $error = array();
	...
	protected function getList() {
		...
		$pagination->url = $this->url->link('sale/input_orders', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('sale/order_list_input', $data));
	}
