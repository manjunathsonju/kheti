...
class ControllerCatalogProduct extends Controller
{
    ...
    public function add()
    {
        ...
        if (
            ...
            if (isset($this->request->get['filter_quantity'])) {
                $url .=
                    '&filter_quantity=' .
                    $this->request->get['filter_quantity'];
            }
    ...
    protected function getList()
    {
            ...
            foreach ($product_specials as $product_special) {
                if (
                    ($product_special['date_start'] == '0000-00-00' ||
                        strtotime($product_special['date_start']) < time()) &&
                    ($product_special['date_end'] == '0000-00-00' ||
                        strtotime($product_special['date_end']) > time())
                ) {
        ...
        $data['results'] = sprintf(
            ...
            $product_total - $this->config->get('config_limit_admin')
                ? $product_total
                : ($page - 1) * $this->config->get('config_limit_admin') +
    ...
    protected function getForm()
    {
        ...
        if (isset($this->request->post['product_description'])) {
            ...
            $data[
                'product_description'
            ] = $this->model_catalog_product->getProductDescriptions(
                $this->request->get['product_id']
            );
        } else {
            $data['product_description'] = [];
        ...
        if (isset($this->request->post['nutritional_value'])) {
            $data['nutritional_value'] =
                $this->request->post['nutritional_value'];
        } elseif (isset($this->request->get['product_id'])) {
            $data[
                'nutritional_value'
            ] = $this->model_catalog_product->getProductDescriptions(
        ...
        if (isset($this->request->post['pcode'])) {
            $data['pcode'] = $this->request->post['pcode'];
        } elseif (!empty($product_info)) {
            $data['pcode'] = $product_info['pcode'];
        } else {
            $data['pcode'] = '';
        }
        ...
        //bind location list to data
        //$data['location_list'] = array('ktm','pkr','ktm,pkr');
        $data['location_list'] = [
            ['title' => 'Kathmandu', 'value' => 'ktm'],
            ['title' => 'Pokhara', 'value' => 'pkr'],
            ['title' => 'Both KTM and PKR', 'value' => 'ktm,pkr'],
        ];
        ...
        $data['tax_option_list'] = [
            ['title' => 'Non-taxable', 'value' => 0],
            ['title' => 'Taxable', 'value' => 1],
        ];

        if (isset($this->request->post['taxable'])) {
            $data['taxable'] = $this->request->post['taxable'];
        } elseif (!empty($product_info)) {
            $data['taxable'] = $product_info['taxable'];
        } else {
            $data['taxable'] = '';
        }
        // var_dump($data['tax']);
        ...
        if (isset($this->request->post['product_store'])) {
            ...
            $data[
                'product_store'
            ] = $this->model_catalog_product->getProductStores(
                $this->request->get['product_id']
            );
        } else {
        ...
        if (isset($this->request->post['product_recurrings'])) {
            $data['product_recurrings'] =
                $this->request->post['product_recurrings'];
        } elseif (!empty($product_info)) {
            $data[
                'product_recurrings'
            ] = $this->model_catalog_product->getRecurrings(
        ...
        if (isset($this->request->post['date_available'])) {
            ...
            $data['date_available'] =
                $product_info['date_available'] != '0000-00-00'
        ...
        if (isset($this->request->post['weight_class_id'])) {
            ...
            $data['weight_class_id'] = $this->config->get(
        ...
        if (isset($this->request->post['length_class_id'])) {
            ...
            $data['length_class_id'] = $this->config->get(
        ...
        foreach ($filters as $filter_id) {
            ...
            if ($filter_info) {
                $data['product_filters'][] = [
                    ...
                    'name' =>
                        $filter_info['group'] . ' &gt; ' . $filter_info['name'],
                ];
            }
        }
        ...
        foreach ($product_attributes as $product_attribute) {
            $attribute_info = $this->model_catalog_attribute->getAttribute(
        ...
        foreach ($product_options as $product_option) {
            ...
            $data['product_options'][] = [
                ...
                'value' => isset($product_option['value'])
        ...
        foreach ($data['product_options'] as $product_option) {
            if (
                ...
                if (
                    !isset($data['option_values'][$product_option['option_id']])
                ) {
                    $data['option_values'][
                        $product_option['option_id']
                    ] = $this->model_catalog_option->getOptionValues(
                        $product_option['option_id']
                    );
                }
            }
        ...
        if (isset($this->request->post['product_discount'])) {
            ...
            $product_discounts = $this->model_catalog_product->getProductDiscounts(
                $this->request->get['product_id']
            );
        } else {
            $product_discounts = [];
        ...
        if (
            ...
            is_file(DIR_IMAGE . $this->request->post['image'])
        ) {
            ...
            !empty($product_info) &&
            is_file(DIR_IMAGE . $product_info['image'])
        ) {
            $data['thumb'] = $this->model_tool_image->resize(
                $product_info['image'],
                100,
        ...
        $data['placeholder'] = $this->model_tool_image->resize(
            'no_image.png',
            100,
            100
        );
        ...
        if (isset($this->request->post['product_image'])) {
            ...
            $product_images = $this->model_catalog_product->getProductImages(
                $this->request->get['product_id']
            );
        } else {
            $product_images = [];
        ...
        if (isset($this->request->post['product_download'])) {
            ...
            $product_downloads = $this->model_catalog_product->getProductDownloads(
                $this->request->get['product_id']
            );
        } else {
            $product_downloads = [];
        ...
        foreach ($product_downloads as $download_id) {
            $download_info = $this->model_catalog_download->getDownload(
                $download_id
            );
        ...
        if (isset($this->request->post['product_related'])) {
            ...
            $products = $this->model_catalog_product->getProductRelated(
                $this->request->get['product_id']
            );
        } else {
            $products = [];
        ...
        foreach ($products as $product_id) {
            $related_info = $this->model_catalog_product->getProduct(
                $product_id
            );
        ...
        if (isset($this->request->post['product_reward'])) {
            ...
            $data[
                'product_reward'
            ] = $this->model_catalog_product->getProductRewards(
                $this->request->get['product_id']
            );
        } else {
            $data['product_reward'] = [];
        ...
        if (isset($this->request->post['product_seo_url'])) {
            ...
            $data[
                'product_seo_url'
            ] = $this->model_catalog_product->getProductSeoUrls(
                $this->request->get['product_id']
            );
        } else {
        ...
        if (isset($this->request->post['product_layout'])) {
            ...
            $data[
                'product_layout'
            ] = $this->model_catalog_product->getProductLayouts(
                $this->request->get['product_id']
            );
        } else {
            $data['product_layout'] = [];
    ...
    protected function validateForm()
    {
        ...
        foreach (
            $this->request->post['product_description']
            as $language_id => $value
        ) {
            if (
                utf8_strlen($value['name']) < 1 ||
                utf8_strlen($value['name']) > 255
            ) {
                $this->error['name'][$language_id] = $this->language->get(
                    'error_name'
                );
            }

            if (
                utf8_strlen($value['meta_title']) < 1 ||
                utf8_strlen($value['meta_title']) > 255
            ) {
                $this->error['meta_title'][$language_id] = $this->language->get(
                    'error_meta_title'
                );
            }
        }
        ...
        if (
            utf8_strlen($this->request->post['model']) < 1 ||
            utf8_strlen($this->request->post['model']) > 64
        ) {
                    ...
                    if (!empty($keyword)) {
                        if (count(array_keys($language, $keyword)) > 1) {
                            $this->error['keyword'][$store_id][
                                $language_id
                            ] = $this->language->get('error_unique');
                        }
                        ...
                        foreach ($seo_urls as $seo_url) {
                            if (
                                ...
                                $this->error['keyword'][$store_id][
                                    $language_id
                                ] = $this->language->get('error_keyword');
    ...
    public function autocomplete()
    {
        ...
        if (
            ...
            foreach ($results as $result) {
                ...
                foreach ($product_options as $product_option) {
                    $option_info = $this->model_catalog_option->getOption(
                        $product_option['option_id']
                    );
                        ...
                        foreach (
                            ...
                            if ($option_value_info) {
                                $product_option_value_data[] = [
                                    ...
                                    'price' => (float) $product_option_value[
                                        'price'
                                    ]
