	...
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'sale/order')) {
				$sale[] = array(
					'name'	   => "Input Orders",
					'href'     => $this->url->link('sale/input_orders', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			...
			if ($this->user->hasPermission('access', 'sale/order')) {
				$sale[] = array(
					'name'	   => "Output Orders",
					'href'     => $this->url->link('sale/output_orders', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			...
			$data['app_href']="index.php?route=app/dash&location=ktm&user_token=".$this->session->data['user_token'];
			$data['report_href']="index.php?route=reports/report&user_token=".$this->session->data['user_token'];

			$data['report_href_b2b']="index.php?route=reports/reportB2B&user_token=".$this->session->data['user_token'];
