...
/* 	public function assignCategories($seller_id,$data=array()) {	
		$query1 = $this->db->query("SELECT seller_id FROM " . DB_PREFIX . "purpletree_vendor_allowed_category  WHERE  seller_id = " . (int)$seller_id . "");
		if($query1->num_rows > 0){
			$this->db->query("UPDATE " . DB_PREFIX . "purpletree_vendor_allowed_category SET category_id = '" . $data['allow_category'] . "', type = '" . (int)$data['type'] . "' WHERE seller_id = '" . (int)$seller_id . "'");	
		}else{ 
			$this->db->query("INSERT INTO " . DB_PREFIX . "purpletree_vendor_allowed_category SET category_id = '" . $data['allow_category'] . "' , type = '" . (int)$data['type'] . "' ,seller_id = '" . (int)$seller_id . "'");
		}
	}
